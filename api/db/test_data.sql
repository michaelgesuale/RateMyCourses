...
INSERT INTO courses(name, campus, description, year, subject) VALUES ('CHM110', 1, 'Matter and its transformations are studied at the macroscopic level. Topics include stoichiometry, phases of matter, equilibria, thermodynamics and electrochemistry.', 2, 'Chemistry');
INSERT INTO courses(name, campus, description, year, subject) VALUES ('SOC100', 1, 'An introduction to the conceptual and empirical foundations of the discipline intended on providing a foundation for subsequent Sociology and Criminology, Law and Society courses and programs. Students will learn the sociological approach of theory and inquiry to a range of topics.', 2, 'Sociology');
...
INSERT INTO courses(name, campus, description, year, subject) VALUES ('CSC148', 1, 'Abstract data types and data structures for implementing them. Linked data structures. Encapsulation and information-hiding. Object-oriented programming. Specifications. Analyzing the efficiency of programs. Recursion. This course assumes programming experience in a language such as Python, C++, or Java, as provided by CSC108H5. Students who already have this background may consult the Computer Science faculty advisor for advice about skipping CSC108H5.', 1, 'Computer Science');
